import { HackMode, HackType, RequiredScript } from "/Orchestrator/HackManager/enum.js";
...
export const HACK_TYPE_PARTIAL_THREAD = [HackType.moneyHack];
...
export const TIMEOUT_THRESHOLD = 180 * 1e3;
export const USE_SHARE = false;
